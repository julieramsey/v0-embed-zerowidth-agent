...
const chatConfig = {
  flowURL:
    "https://api.zerowidth.ai/v1/process/HBOKK5PTsNshxIHDYnLT/9vGPaHfd6rD70nu72pyD",
  header: {
    title: "Chat with Julie",
    description:
      "Greetings, I am a draft clone of Julie running the DOCTOR script. HOW DO YOU DO. PLEASE STATE YOUR PROBLEM.",
  },
